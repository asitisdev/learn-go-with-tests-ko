...
제네릭 버전의 차이점은 _여전히 특정 타입을 설명_하고 있다는 것입니다. 이것이 의미하는 바는 이 함수가 _하나의_ 타입으로만 작동하도록 제한했다는 것입니다.
...
배열, 슬라이스 또는 맵을 사용했다면 _이미 제네릭 코드의 소비자였습니다_.
...
빨강, 초록, 리팩토링의 TDD 사이클은 **추상화를 미리 상상하는 대신** 동작을 전달하는 데 _실제로 필요한_ 코드에 대한 더 많은 안내를 제공합니다.
